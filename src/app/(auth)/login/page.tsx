...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center bg-[#09090b] overflow-hidden font-sans text-white px-4">
      {/* Ambient Background */}
      ...
      <div className="z-10 w-full max-w-[400px] rounded-2xl border border-white/5 bg-[#121214]/80 p-6 sm:p-8 shadow-2xl backdrop-blur-sm">
        {/* Header */}
        <div className="mb-6 sm:mb-8 text-center">
          <h1 className="mb-2 text-2xl sm:text-3xl font-medium text-white/90">
        ...
        {/* Error Message */}
        {error && (
          <div className="mb-4 sm:mb-6 flex items-start gap-3 rounded-lg border border-red-500/20 bg-red-500/10 p-3 text-sm text-red-200">
        ...
        >
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-lg bg-[#b91c1c] py-3 text-sm font-medium text-white transition-all hover:bg-red-700 active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed touch-manipulation"
          >
            {isLoading ? (
        ...
        {step === "OTP" && (
          <button
            ...
            className="mt-6 w-full text-center text-xs text-neutral-500 hover:text-white transition-colors py-2 touch-manipulation"
          >
