...
import { Search, Download, Loader2, Plus, QrCode, X, MapPin } from 'lucide-react';
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    ...
                    <p className="text-neutral-400 text-sm">Manage locations and view access codes.</p>
                </div>
                <button
                                ...
                                >
                                    <td className="p-4 pl-6">
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[10px] text-neutral-500 font-mono">{house.id}</span>
                                        </div>
                                    </td>
...
function CreateHouseModal({ onClose }: { onClose: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            <div className="w-full max-w-md bg-[#18181b] border border-neutral-800 rounded-2xl shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div>
                        <label className="block text-xs font-medium text-neutral-400 mb-1">House Name</label>
                        <input
                            required
                            type="text"
                            value={formData.name}
                    ...
                    <div>
                        <label className="block text-xs font-medium text-neutral-400 mb-1">Location / City</label>
                        <input
                            required
                            type="text"
...
function HouseDetailsModal({ house, onClose }: { house: House, onClose: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            <div className="w-full max-w-lg bg-[#18181b] border border-neutral-800 rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="p-8 flex flex-col items-center justify-center text-center">
                    <div className="bg-white p-4 rounded-xl mb-6 shadow-lg">
                        {house.qrCode ? (
                            ...
                            <div className="w-48 h-48 bg-neutral-100 flex items-center justify-center text-neutral-400 text-sm">
                                QR Not Available
                            </div>
                        )}
                    </div>
                    ...
                    <p className="text-neutral-400 text-sm max-w-xs mb-6">
                        Scan this code with the Player App to instantly join <strong>{house.name}</strong>.
                    </p>

                    <div className="grid grid-cols-2 gap-4 w-full text-sm">
                        <div className="bg-[#111113] p-3 rounded-lg border border-neutral-800">
                            <span className="block text-neutral-500 text-xs mb-1">House ID</span>
                            <span className="font-mono text-white select-all">{house.id}</span>
                        </div>
                        <div className="bg-[#111113] p-3 rounded-lg border border-neutral-800">
                            <span className="block text-neutral-500 text-xs mb-1">Active Tables</span>
                    ...
                    <button
                        ...
                        className="mt-6 w-full py-2.5 bg-white text-black hover:bg-neutral-200 font-medium rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
