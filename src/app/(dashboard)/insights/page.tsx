      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 bg-[#18181b] border border-neutral-800 rounded-lg text-sm text-neutral-300 hover:text-white transition-colors"
          >
            <Download size={16} />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-[#111113] border border-neutral-900/50 rounded-2xl p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <span className="bg-red-500/10 text-red-500 text-xs font-medium px-2 py-0.5 rounded animate-pulse">
              Live
            </span>
          </div>
